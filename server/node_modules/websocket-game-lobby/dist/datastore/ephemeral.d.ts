...
export declare class EphemeralDataStore extends Listeners<DataStoreEvents> implements IDataStore {
    listeners: {};
    setup(): Promise<void>;
    createGame(gameCode?: string): Promise<Game>;
    findGame(gameId: string): Promise<Game | undefined>;
    findGameWithCode(gameCode: string): Promise<Game | undefined>;
